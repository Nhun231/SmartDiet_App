...
export default function PersonalScreen({ route }) {
    ...
    const chartKitData = {
        labels: chartData.map(d => d.x.toLocaleDateString()),
...
const styles = StyleSheet.create({
    ...
    header: { backgroundColor: '#10b981', paddingHorizontal: 16, paddingVertical: 12 },
    headerContent: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 16 },
    profileAvatar: {
        width: 48, height: 48, backgroundColor: 'white', borderRadius: 24,
    ...
    bmiCenter: { alignItems: 'center', marginBottom: 24 },
    bmiLabel: { fontSize: 24, fontWeight: 'bold', color: '#1f2937', marginBottom: 4 },
    bmiValue: { fontSize: 36, fontWeight: 'bold', color: '#ef4444', marginBottom: 8 },
    timestampRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
    timestampText: { fontSize: 14, color: '#9ca3af' },
    updateText: { fontSize: 14, color: '#f59e0b' },
    statsRow: { flexDirection: 'row', justifyContent: 'space-around' },
    statItem: { alignItems: 'center' },
    statValue: { fontSize: 24, fontWeight: 'bold', color: '#1f2937' },
    statLabel: { fontSize: 14, color: '#9ca3af', marginTop: 4 },
    waterCenter: { alignItems: 'center', marginBottom: 24 },
    waterValueRow: { flexDirection: 'row', alignItems: 'baseline', marginBottom: 4 },
    waterValue: { fontSize: 36, fontWeight: 'bold', color: '#ef4444' },
    waterUnit: { fontSize: 18, color: '#9ca3af', marginLeft: 4 },
    waterLabel: { fontSize: 14, color: '#9ca3af', marginBottom: 24 },
    waterControls: { flexDirection: 'row', gap: 16, marginBottom: 24 },
    waterButton: {
    ...
    goalTitle: { fontSize: 18, fontWeight: '500', color: '#1f2937' },
    addButton: {
        width: 32, height: 32, borderRadius: 16, borderWidth: 1,
        borderColor: '#d1d5db', justifyContent: 'center', alignItems: 'center',
    },
    chartContainer: { position: 'relative', height: 120, borderRadius: 8, overflow: 'hidden' },
    dietPlanBox: {
